...
data class GeofenceItem(
    ...
    fun setNameAndImage() {
        if (this.id == R.raw.lleida) {
            ...
            this.forbiddenStickers =
                listOf(EnvironmentalSticker(EnvironmentalStickerEnum.None, R.drawable.pegatinanone))
            this.imageId = R.drawable.lleida_zbe
            this.url =
                "https://firebasestorage.googleapis.com/v0/b/zbesp-a6692.appspot.com/o/Lleida-ZBE.jpg?alt=media&token=de18e797-6787-4dd8-892f-1eac811eb5a8"
        }
        if (this.id == R.raw.zaragoza) {
            ...
            this.url =
                "https://firebasestorage.googleapis.com/v0/b/zbesp-a6692.appspot.com/o/Zaragoza-ZBE.jpg?alt=media&token=2f511711-0f26-415a-867f-d84bf5c98f05"
        }
        if (this.id == R.raw.madrid) {
            ...
            this.url =
                "https://firebasestorage.googleapis.com/v0/b/zbesp-a6692.appspot.com/o/Madrid-ZBE.png?alt=media&token=2e30367b-d26d-4de1-b649-4159ac9fa953"
        }
        if (this.id == R.raw.barcelona) {
            ...
            this.url =
                "https://firebasestorage.googleapis.com/v0/b/zbesp-a6692.appspot.com/o/Barcelona-ZBE.jpg?alt=media&token=4c4c903f-4744-4363-a65c-7f3242fee679"
        }
    }
